class Reciter {
  ...
  factory Reciter.fromMap(Map<String, dynamic> json) {
    return Reciter(
      ...
      serverUrl: json['id']==107 ?'https://download.quranplayermp3.com/quran/Muhammad-Al-Luhaidan/':json['server'],
      style: json['style'],
      totalSurah: json['total_surah'],
      surahsList:
          json['surahs_list'] is List<String> ? json['surahs_list'] : List<String>.from(json['surahs_list'] ?? []),
    );
  }
  ...
  // sim sim write a copyWith functin here
...
class Mushaf {
  ...
  factory Mushaf.fromMap(Map<String, dynamic> json) {
    return Mushaf(
      ...
      surahsList: json['surah_list'] == null && json['surahs_list'] is Iterable
